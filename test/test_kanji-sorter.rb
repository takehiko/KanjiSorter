...
class TestKanjiYear < Minitest::Unit::TestCase
  def test_years
  ...
  def test_kanji_sorter
    seq = "大阪府兵庫県京都府滋賀良県和歌山県三重県香川県徳島県"
    ...
    assert_match(/県県県県県県庫重都島和/, ks2017_freq_grade[3])
    assert_match(/賀香滋徳阪府府兵良/, ks2017_freq_grade[4])
